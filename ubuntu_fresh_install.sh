...
Would you like to install a WireGuard VPN Server? If so enter y / If you don't wish to install enter n
...
if [[ $vpn -eq "y" ]] || [[ $vpn -eq "yes" ]] ; then 
    wget https://raw.githubusercontent.com/Charlie67j/wginstall/main/wireguard_install.sh -O wireguard-install.sh
